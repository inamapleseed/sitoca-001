    ...
    <div class="panel panel-default">
	  ...
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li class="hidden"><a href="#tab-seo" data-toggle="tab"><?php echo $tab_seo; ?></a></li>
            <li class="hidden"><a href="#tab-custom" data-toggle="tab"><?php echo $tab_custom; ?></a></li>
            <li class=""><a href="#tab-settings" data-toggle="tab"><?php echo $tab_settings; ?></a></li>
