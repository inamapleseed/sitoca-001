        ...
        <form class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="address_2" value="<?php echo $payment_address_2; ?>" id="input-payment-address-2" class="form-control" />
							...
							<div class="form-group">
                <label class="col-sm-2 control-label" for="input-payment-unit-no"><?php echo $entry_unit_no; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="unit_no" value="<?php echo $payment_unit_no; ?>" id="input-payment-unit-no" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-shipping">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-shipping-unit-no"><?php echo $entry_unit_no; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="unit_no" value="<?php echo $shipping_unit_no; ?>" id="input-shipping-unit-no" class="form-control" />
                </div>
              </div>
              <div class="form-group">
