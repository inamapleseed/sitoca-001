      ...
      <div class="panel-body">
        <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-all-pages" data-toggle="tab">All Pages</a></li>
          </ul>
          <div class="tab-content">
            <div class="tab-pane" id="tab-all-pages">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-footer_logo">Footer footer logo</label>
                <div class="col-sm-10"><a href="" id="thumb-footer_logo" data-toggle="image" class="img-thumbnail"><img src="<?= $footer_logo; ?>" alt="" title="" data-placeholder="<?= $placeholder; ?>" /></a>
                  <input type="hidden" name="config_footer_logo" value="<?= $config_footer_logo; ?>" id="input-footer_logo" />
                </div>
              </div>
            </div>
