<?php
	class ControllerCommonColumnLeft extends Controller {
		public function index() {
			if(!defined('IN_DEVELOPMENT')) define('IN_DEVELOPMENT', serialize(array()));
			...
			/*	if ($this->user->hasPermission('access', 'catalog/recurring')) {
				...
				*/
				...
				if ($this->user->hasPermission('access', 'extension/bganycombi')) {
					$marketing[] = array(
						'name'	   => $this->language->get('text_bganycombi'),
						'href'     => $this->url->link('extension/bganycombi', 'token=' . $this->session->data['token'], true),
						'children' => array()
						);
				}
