	...
	<div class="box-content">
		...
		<?php } else { ?>
			...
			<?php if (!empty($settings['moduletext_top_'.$language])) { ?>
				<div class="mi-toptext hidden"><?php echo html_entity_decode($settings['moduletext_top_'.$language], ENT_QUOTES, 'UTF-8'); ?></div>
			<?php } ?>
			...
			<div class="newsletter-grid">
				...
				<?php if (!$subscribed) { ?>
					<div class="mi-block mi-button">
						<a class="button btn btn-primary btn-mi" onclick="miSubscribe<?php echo $module_id; ?>($(this))"><i class="fa fa-paper-plane" aria-hidden="true"></i></a>
					</div>
